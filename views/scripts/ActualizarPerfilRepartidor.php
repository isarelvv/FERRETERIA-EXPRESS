...
<body>
    ...
    $cadena = "UPDATE repartidores SET NOMBRE='$nombre',APELLIDOS='$apellidos',CORREO='$correo', TELEFONO='$telefono',PLACAS='$placas',NUM_LICENCIA='$licencia' where ID_REPARTIDOR='$id_repartidor'";
