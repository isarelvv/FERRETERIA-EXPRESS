            ...
            <div class="row border border-secondary contenedor_carrito">
                ...
                <div class="col-lg-8 col-sm-12 mb-sm-4">
                    <div class="border border-secondary     fondo_info_detalles">
                            ...
                            <div class='row border border-secondary     productos'>
                                ...
                                <div class='col  info_producto_carrito'>
                                    <div class='row justify-content-between'>
                                        <div class='col-lg-9 col-sm-4 offset-lg-0 offset-sm-1   nombre_producto'>
                        ...
                        ?>     
                        <div class='col-lg-3 col-sm-4 text-end  precio_total'>
                            <b>  CANTIDAD:
                        <?php
                        {
                        ?>  
                         ...
                         ?>
                                ...
                                <div class="row     barra_baja">
                                    ...
                                    <div class="col row">
                                        ...
                                        <div class="col-lg-4 col-sm-7   d_p">
                        ...
                        ?>
                        <a href="carrito.php?vaciar=true" class="offset-lg-10 col-lg-3 col-sm-3 offset-sm-9">Vaciar Carrito</a>
                ...
                <div class="col-lg-4 col-sm-12">
                    ...
                    <div class="border border-secondary     cuadros_detalles fondo_compra">
                        ...
                        <div class="row">
                            ...
                            <div class="col col-sm-1  opciones_resumen_dos">
                                <p><?php echo "$" . $total ?></p>
                            </div>
                        </div>
                    </div>
