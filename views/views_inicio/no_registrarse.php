                ...
                <form action="">
                    ...
                    <div class="border border-secondary rounded-2    contenedores_form">
                        ...
                        <div class="form-floating">
                            <input class="form-control is-invalid  conf_labels" type="text" id="nombre" placeholder="Nombre">
                            <label class="form-label"  for="nombre">Nombre</label>
                        </div>
                        <!--Apellido Paterno-->
                        <div class="form-floating">
                            <input class="form-control is-invalid  conf_labels" type="text" id="a_p" placeholder="Apellido Paterno">
                            <label class="form-label" for="a_p">Apellido Paterno</label>
                        </div>
                        <!--Apellido Materno-->
                        <div class="form-floating">
                            <input class="form-control is-invalid  conf_labels" type="text" id="a_m" placeholder="Apellido Materno">
                            <label class="form-label" for="a_m">Apellido Materno</label>
                        </div>
                        <!--Correo Electronico-->
                        <div class="form-floating">
                            <input class="form-control is-invalid  conf_labels" type="email" id="correo" placeholder="Correo Electronico">
                            <label class="form-label" for="correo">Correo Electronico</label>
                        </div>
                        <!--Numero de Telefono-->
                        <div class="form-floating">
                            <input class="form-control is-invalid  conf_labels" type="tel" id="telefono" placeholder="Numero de Telefono">
                    ...
                    <div class="border border-secondary rounded-2    contenedores_form">
                        ...
                        <!--Direccion-->
                        <div class="form-floating">
                            <input class="form-control is-invalid  conf_labels" type="text" id="direccion" placeholder="Direccion">
                            <label class="form-label" for="direccion">Direccion</label>
                        </div>
    
                        <!--Codigo Postal-->
                        <div class="form-floating">
                            <input class="form-control is-invalid text-decoration-none  conf_labels" type="text" id="cp" placeholder="Codigo Postal" style="max-width: 200px;">
                    ...
                    <div class="border border-secondary rounded-2    contenedores_form">
                        ...
                        <!--Contraseña-->
                        <div class="form-floating">
                            <input class="form-control is-invalid  conf_labels" type="password" id="contra" placeholder="Contraseña">
                        ...
                        <!--Repetir Contraseña-->
                        <div class="form-floating">
                            <input class="form-control is-invalid  conf_labels" type="password" id="rcontra" placeholder="Repetir Contraseña">
